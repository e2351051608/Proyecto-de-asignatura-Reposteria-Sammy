namespace ReposteriaSammy_s
{
    public class Pasteles : Menú
    {
        ...
        public void EscogerPedido()
        {
            ...
            Console.WriteLine("Elija el sabor del pastel: \nChocolate-----1 \nFresa-----2 \nVainilla-----3");
            ...
            if (sabor == 1)
            {
                ...
                Console.WriteLine("Usted ha comprado " + cantidad_chocolate + " Pastel de Chocolate");
            ...
            else if (sabor == 2)
            {
                ...
                //mesaje de la compra
                Console.WriteLine("Usted ha comprado " + cantidad_fresa + " Pastel de Fresa");
            ...
            else
            {
                ...
                //mesaje de la compra
                Console.WriteLine("Usted ha comprado " + cantidad_vainilla + " Pastel de Vainilla");
