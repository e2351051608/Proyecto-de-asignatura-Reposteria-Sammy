namespace ReposteriaSammy_s
{
    public class Helados : Menú
    {
        ...
        public void EscogerPedido()
        {
            ...
            Console.WriteLine("Elija el sabor del helado: \nVainilla-----1 \nFresa-----2 \nOreo-----3\n");
            ...
            if (sabor == 1)
            {
                ...
                Console.WriteLine("Usted ha comprado " + cantidad_vainilla + " Helado de vainilla");
            ...
            else if (sabor == 2)
            {
                ...
                //mesaje de la compra
                Console.WriteLine("Usted ha comprado " + cantidad_fresa + " Helado de Fresa");
            ...
            else
            {
                ...
                //mesaje de la compra
                Console.WriteLine("Usted ha comprado " + cantidad_oreo + " Helados de Oreo");
